        ...
        >
          ...
          <Paper variant="outlined" sx={{ p: 2, borderRadius: 2, mb: 2 }}>
            <Grid container spacing={1}>
              ...
              <Grid size={{ xs: 6, md: 2 }}>
                <TextField fullWidth size="small" label="Turno 1" />
              </Grid>
              <Grid size={{ xs: 6, md: 2 }}>
                <TextField fullWidth size="small" label="Turno 2" />
              </Grid>
              <Grid size={{ xs: 6, md: 2 }}>
                <TextField fullWidth size="small" label="Turno 3" />
              </Grid>
              <Grid size={{ xs: 6, md: 2 }}>
                <TextField fullWidth size="small" label="Rectificado" />
              </Grid>
              <Grid size={{ xs: 6, md: 2 }}>
                <TextField fullWidth size="small" label="Total produccion" />
              </Grid>
            </Grid>
          </Paper>
          <Paper variant="outlined" sx={{ p: 2, borderRadius: 2, mb: 2 }}>
            <Grid container spacing={1}>
              ...
              <Grid size={{ xs: 6, md: 1 }}>
                <TextField fullWidth size="small" label="Extra" />
              </Grid>
              <Grid size={{ xs: 6, md: 1 }}>
                <TextField fullWidth size="small" label="Standard" />
              </Grid>
              <Grid size={{ xs: 6, md: 1 }}>
                <TextField fullWidth size="small" label="Extra" />
              </Grid>
