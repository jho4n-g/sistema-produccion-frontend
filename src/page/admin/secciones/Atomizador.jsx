...
export default function Atomizador() {
  ...
  const filtered = useMemo(() => {
    ...
    return row.filter((r) => {
      ...
      const matchObs = r.observacionesAtomizadoDatos?.some((o) =>
                  ...
                  <>
                    {paginated.map((r, idx) => (
                      <TableRow key={r.id ?? idx}>
                        ...
                        <TableCell>{r.hora_final}</TableCell>

                        <TableCell colSpan={2}>
                          {r.observacionesAtomizadoDatos?.length
                            ? r.observacionesAtomizadoDatos
